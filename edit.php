...
$siswa = $conn->query("SELECT * FROM tbl_siswa_05 WHERE idsiswa05 = '$id'")->fetch_assoc();
...
if (isset($_POST['submit'])) {
    ...
    $edit = $conn->query("UPDATE tbl_siswa_05 SET nmsiswa05 = '$nama', tlpsiswa05 = '$telp', jursiswa05 = '$jurusan' WHERE idsiswa05 = '$id'");
        ...
        <form action="" method="post">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <input class=" form-control" type="text" name="nmsiswa05" id="n" value="<?= $siswa['nmsiswa05'] ?>">
                    <label class=" form-label mt-2" for="u">Telepon</label>
                    <input class=" form-control" type="text" name="tlpsiswa05" id="u" value="<?= $siswa['tlpsiswa05'] ?>">
                </div>
                <div class="col-lg-6">
                    <label class=" form-label" for="p">Jurusan</label>
                    <input class=" form-control" type="text" name="jursiswa05" id="p" value="<?= $siswa['jursiswa05'] ?>">
                </div>
